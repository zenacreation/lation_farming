...
RegisterNetEvent('lation_farming:completesmelt', function(ingotId)
    ...
    if not hasItems then
        TriggerClientEvent('lation_farming:notify', source, locale('notify.missing-item'), 'error')
        return
    end
    ...
    farming:AddPlayerData(source, 'smelted', 1)
